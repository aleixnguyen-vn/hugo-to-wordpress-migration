...
<h1 class="font-bold" style="font-size: 28px; color:#fff">Browse the mods players love the most.</h1>
<p>
...
$args = [
    'post_type'      => 'post',
    'posts_per_page' => 18,
    'meta_key'       => 'view_count', // mặc định ưu tiên theo views
    'orderby'        => [
        'meta_value_num' => 'DESC',
    ],
    'meta_query'     => [
            ...
            <div class="lg:col-12">
                <div class="row">
                    ...
                    if ($popular_query->have_posts()) :
                        ...
                        echo '<p>No popular mods found.</p>';
                    endif;
                    ?>
                </div>
            </div>
